defmodule TwittexWeb.Router do
  ...
  scope "/", TwittexWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TwittexWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TwittexWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/tweets/:tweet_id/comments", TweetLive.Index, :show_comments
  ...
  scope "/", TwittexWeb do
    ...
    live_session :current_user,
      on_mount: [{TwittexWeb.UserAuth, :mount_current_user}] do
